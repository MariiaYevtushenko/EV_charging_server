-- GetFinalSessionAmount: виклик GetTariffPricePerKwhAt лише з timestamp
-- (одноаргументна функція сама визначає DAY/NIGHT через GetTariffPeriodType).
-- Виправлення помилки «функції gettariffpriceperkwhat(timestamp, tariff_period) не існує».
